...
/// between a [View] instance and a [SceneSwitcher], enabling responsive user interface
...
public abstract class Controller {
  ...
  /// Constructs a Controller instance, linking a [SceneSwitcher] with a [View], and
  ...
  /// Retrieves the associated [View] instance managed by this controller.
  ///
  /// @return the [View] instance linked with this controller.
  public View getView() {
    return view;
  }

  /// Switches the current view to the specified scene using the associated [SceneSwitcher].
  ///
  /// @param name the name of the target scene to switch to; must be one of the defined
