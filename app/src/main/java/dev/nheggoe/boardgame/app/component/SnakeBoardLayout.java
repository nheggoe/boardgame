...
public final class SnakeBoardLayout {
  ...
  /// Converts a 1-based tile number to a 2D grid coordinate (`col`, `row`).
  ///
  /// The conversion assumes a square board where rows alternate a direction—left-to-right and
  ...
  /// @return [Point2D] representing the column and row indices
