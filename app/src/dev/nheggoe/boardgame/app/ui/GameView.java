...
///
/// This class defines the components and layout for a game view, including the game board, player
...
public abstract class GameView<T extends Tile, P extends Player> extends View {
  ...
  /// Constructs a new [GameView] instance by initializing its layout, including the game
  /// board, the right pane for player interactions, and the bottom pane for displaying messages.
  ///
  /// @param sceneSwitcher an instance of [SceneSwitcher] used to switch between scenes in the
  ///     application
  /// @param eventBus the [EventBus] for communication between different components and events
  ...
  ///     view
  /// @param rollDiceAction an [EventHandler] for handling roll dice actions in the game
  protected GameView(
  ...
  ///
  /// Classes extending this abstract class should implement this method to provide the center
  /// pane
  ///
  ...
  /// @return a [Pane] representing the center of the game view
  ...
  ///
  /// @param sceneSwitcher an instance of [SceneSwitcher] used to handle scene transitions
  /// @param eventBus the [EventBus] for communication and event handling between components
  /// @param players a [Supplier] providing the list of players displayed in the player
  ///     dashboard
  /// @param rollDiceHandler an [EventHandler] for handling actions related to rolling dice
  /// @return a [Pane] representing the right section of the game view
  ...
  ///
  /// @return the [PlayerDashboard] instance
  ...
  /// Creates and returns the bottom pane of the game view, which contains a [MessagePanel] for
  /// displaying messages or logs related to the game. The [MessagePanel] is set up to take
  /// approximately 28% of the height of the [GameView] and is added as a component to the game
  /// view.
  ///
  /// @param eventBus the [EventBus] used for communication and event handling between various
  ///     components of the application
  /// @return a [Pane] representing the bottom section of the game view
  ...
  ///
  /// @return the [MessagePanel] instance
