...
/// `GoToJailTile` represents the tile that sends a player directly to jail when landed on.
///
...
public final class GoToJailMonopolyTile extends CornerMonopolyTile {
  ...
  /// Constructs a `GoToJailMonopolyTile` at the specified position on the game board. This
