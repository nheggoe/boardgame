...
/// `JailTile` represents a jail tile on the game board.
///
/// Players can be sent to jail for a number of rounds, during which their movement may be
/// restricted. This class tracks which players are jailed and how many rounds they have left.
///
/// Extends [CornerMonopolyTile].
///
/// @author Mihailo
/// @version 2025.04.25
public final class JailMonopolyTile extends CornerMonopolyTile {
  ...
  /// Constructs a `JailTile` at the given board position.
  ///
  ...
  ///
  /// If the player has no remaining rounds after decrementing, they are released from jail.
  ///
