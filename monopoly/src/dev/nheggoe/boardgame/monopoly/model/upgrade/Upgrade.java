...
public record Upgrade(UpgradeType type, int rentMultiplierPercentage) {
  ...
  /// Constructor for the `Upgrade` record, ensuring the rent multiplier percentage is valid.
  ///
  ...
  /// @throws IllegalArgumentException if `rentMultiplierPercentage` is negative.
  public Upgrade {
