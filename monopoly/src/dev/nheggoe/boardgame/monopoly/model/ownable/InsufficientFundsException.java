...
/// funds.
///
/// This exception is typically utilized in scenarios where an attempt is made to spend more funds
...
///
/// Constructors: - [#InsufficientFundsException(String)] allows specifying a custom error
/// message. - [#InsufficientFundsException(int, int)] generates a formatted message indicating
