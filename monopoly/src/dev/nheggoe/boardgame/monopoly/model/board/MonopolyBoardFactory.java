...
/// The `BoardGameFactory` class is a factory class that creates different types of boards. It
...
public class MonopolyBoardFactory {
  ...
  /// @return a [MonopolyBoard] instance created according to the specified layout
