...
///
/// All implementations of this interface define immutable records that encapsulate details of
...
public sealed interface MonopolyEvent extends Event {
  ...
  ///
  /// Instances of this record encapsulate information about the player who made the purchase and
  ...
  ///
  /// Instances of this record encapsulate information about the player performing the upgrade and
  ...
  ///
  /// An instance of this record encapsulates the information about the player who has been sent
  /// to jail.
  ///
