...
///
/// The implementations of this interface include: - `Property`: Represents properties with
/// specific colors, upgrades, and varying rent. - `Railroad`: Represents a type of ownable
/// entity with fixed rent. - `Utility`: Represents utilities where rent is based on game
/// mechanics like dice rolls.
///
/// Use this interface to implement any game components that can be bought and generate rent.
