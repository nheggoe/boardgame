...
/// board.
///
/// This class is an abstract sealed type, permitting only specific subclasses to model the
...
/// maintainability.
///
/// A CornerMonopolyTile has an associated position, constrained to one of four predefined corner
/// positions on the board: TOP_LEFT, TOP_RIGHT, BOTTOM_LEFT, or BOTTOM_RIGHT. The [Position]
/// enum defines these positions.
///
/// This class provides: - Validation to ensure that the position cannot be null during
...
///
/// Permitted subclasses modeling different corner tiles are: [FreeParkingMonopolyTile],
/// [GoToJailMonopolyTile], [JailMonopolyTile], and [StartMonopolyTile].
///
...
public abstract sealed class CornerMonopolyTile implements MonopolyTile
  ...
  /// Constructs a [CornerMonopolyTile] with a specified board position.
  ///
  ...
  ///
  /// @return the `Position` associated with this corner tile, representing one of the four
  ...
  ///
  /// This enum is used to represent the specific locations occupied by corner tiles on the board.
