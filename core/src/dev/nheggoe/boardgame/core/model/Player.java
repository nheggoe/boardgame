...
/// The `Player` class represents a player in the board game. Each player has a name and a
...
public abstract class Player {
  ...
  ///
  /// Each enum constant corresponds to a unique figure, such as a battleship or a hat, that a
