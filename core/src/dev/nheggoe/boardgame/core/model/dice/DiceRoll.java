...
public record DiceRoll(int... rolls) {
  ...
  /// Constructs a [DiceRoll] instance that encapsulates the face values of one or more dice
  ...
  ///     1 and 6 inclusive
  /// @throws IllegalArgumentException if `rolls` is empty or contains values less than 1 or
  ///     greater than 6
  public DiceRoll {
    if (rolls.length < 1) {
