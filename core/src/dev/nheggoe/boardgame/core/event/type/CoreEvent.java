...
public sealed interface CoreEvent extends Event {
  ...
  /// of the [CoreEvent] interface, encapsulating the result of the dice roll.
  ///
  ...
  /// implementation of the [CoreEvent] interface to encapsulate information about the player's
  /// movement.
  ///
  ...
  ///
  /// This record serves as a concrete implementation of the [CoreEvent] interface,
  /// encapsulating the removal of a player without additional metadata or parameters.
  ///
  /// The purpose of this event is to signal that a player has been removed, enabling other
