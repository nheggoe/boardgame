...
public sealed interface UserInterfaceEvent extends Event {
  ...
  ///
  /// This record ensures immutability and type safety when processing events related to user
  /// interface outputs. The message encapsulated in this event cannot be null and must be specified
  /// upon creation. It serves as a concrete implementation of the [UserInterfaceEvent]
  /// interface.
  ///
