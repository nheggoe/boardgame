...
/// layout rules.
///
/// The [InvalidBoardLayoutException] can provide additional details about the error through
/// its constructors, including a custom message describing the issue in more detail.
///
/// Common use cases for this exception include: - Asserting the presence of required tiles in a
